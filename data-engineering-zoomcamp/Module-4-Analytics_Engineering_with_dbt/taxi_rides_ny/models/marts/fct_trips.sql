-- To get all our trips, we must do a union between the green and the yellow data
-- This is bettwer done in an intermediate table
...
from {{ ref('int_trips_union') }} as trips
